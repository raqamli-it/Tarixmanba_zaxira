...
var InputText = React6.memo(React6.forwardRef(function(inProps, ref) {
  ...
  return React6.createElement(React6.Fragment, null, React6.createElement("input", _extends3({
    ref: elementRef
  }, rootProps)), hasTooltip && React6.createElement(Tooltip, _extends3({
    target: elementRef,
...
var InputMask = React7.memo(React7.forwardRef(function(inProps, ref) {
  ...
  var firstNonMaskPos = React7.useRef(null);
  var lastRequiredNonMaskPos = React7.useRef(0);
  var tests = React7.useRef([]);
  var buffer = React7.useRef([]);
  var len = React7.useRef(0);
  var oldVal = React7.useRef(null);
  var focus = React7.useRef(false);
  var focusText = React7.useRef(null);
  var isValueChecked = React7.useRef(null);
  var partialPosition = React7.useRef(null);
  var defaultBuffer = React7.useRef(null);
  var caretTimeoutId = React7.useRef(null);
  var androidChrome = React7.useRef(false);
  var metaData = {
    props
  };
  ...
  var getPlaceholder = React7.useCallback(function(i) {
  ...
  var getUnmaskedValue = React7.useCallback(function() {
    var unmaskedBuffer = [];
  ...
  var isValueUpdated = React7.useCallback(function() {
  ...
  return React7.createElement(InputText, _extends4({
    ref: elementRef,
