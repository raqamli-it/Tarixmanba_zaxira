...
const TabsWithMap = () => {
  ...
  const tabse = [
    {
      title: 'Arxeolgiya',
      icon: <MdCastle className='w-6 h-6 transition-all duration-300 text-[white]' />,
      bgClass: 'bg-[#252424]',
      name: 'Tab 3',
      menus: [
        {
    ...
    },
    {
      ...
      icon: <FaPeopleGroup className='w-6 h-6 transition-all duration-300 text-[white]' />,
      bgClass: 'bg-[#252424]',
      name: 'Tab 2',
      menus: [
        {
    ...
    {
      title: 'Btiklar',
      icon: <IoNewspaperSharp className='w-6 h-6 transition-all duration-300 text-[white]' />,
      bgClass: 'bg-[#252424]',
      name: 'Tab 1',
      menus: [
        {
    ...
    },
    {
      ...
      icon: <TbBuildingArch className='w-6 h-6 transition-all duration-300 text-[white]' />,
      bgClass: 'bg-[#252424]',
      name: 'Tab 1',
      menus: [
        {
    ...
    {
      title: 'Yozma asarlar',
      icon: <RiFilePaper2Fill className='w-6 h-6 transition-all duration-300 text-[white]' />,
      bgClass: 'bg-[#252424]',
      menus: [
        {
          name: 'Multiple Locations',
    ...
    {
      title: 'Tangalar',
      icon: <GiTwoCoins className='w-6 h-6 transition-all duration-300 text-[white]' />,
      bgClass: 'bg-[#252424]',
    },
  ...
  return (
    <div className="maps-container mt-[100px]">
            ...
            {tabse.map(({ title, bgClass, icon, menus }, index) => (
              ...
              >
                <div
                  ...
                  className={`${bgClass} ${active === index ? 'right-0' : active < index ? '-right-full' : 'right-full'
                ...
                >
                  <span
                    ...
                    className={`${activeTxt === index ? 'bg-[#514f4f]' : bgClass
                  ...
                  <span
                    className={`hidden md:block transition-all duration-300 ${activeTxt === index ? 'text-[white]' : ''
                      }`}
                  >
                    {title}
                  </span>
      ...
      <MapContainer center={selectedLocations[0].coords[0]} zoom={3} className="home-map-container">
        <TileLayer
          url="https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png"
          attribution='&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'
        />
        {selectedLocations[0]?.coords.map((location, index) => (
