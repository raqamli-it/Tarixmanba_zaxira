...
export default function Namuna() {
  return (
    <div>
      <div className="container">
        <div className="card__container">
          <article className="card__article">
            <img src="https://img.freepik.com/free-photo/beautiful-anime-kid-cartoon-scene_23-2151035243.jpg?size=626&ext=jpg" alt="image" className="card__img" />
