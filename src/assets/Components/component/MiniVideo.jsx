...
const MiniVideo = ({ data }) => {
  ...
  return (
    <section className=" dark:bg-dark flex justify-center lg:pb-[20px]">
          ...
          <div className="w-full px-4 lg:w-10/12">
            <div className="relative z-20 h-[300px] overflow-hidden rounded-lg md:h-[450px]">
              <div className="absolute left-0 top-0 h-full w-full">
                <img
                  src='https://img.freepik.com/free-vector/flat-black-video-media-player-web-template_1017-23407.jpg?ga=GA1.1.712431129.1720501895&semt=ais_hybrid'
                  alt="bg"
              ...
              >
                <a
                  ...
                  className="absolute z-20 flex h-20 w-20 items-center justify-center rounded-full bg-black  text-primary dark:bg-dark-2 dark:text-white md:h-[100px] md:w-[100px]"
                >
      ...
      {videoOpen && (
        <div className="fixed left-0 top-0 z-50 flex h-screen w-full items-center justify-center bg-black bg-opacity-90">
          <div className="mx-auto w-full max-w-[550px] bg-white">
            <>
              {data?.videos?.length > 0 ? data?.videos?.map((e) =>
                <iframe
          ...
          >
            <svg viewBox="0 0 16 15" className="h-8 w-8 fill-current text-white  hover:text-cyan-500">
