...
const Tabs = () => {
  ...
  return (<main className={`flex min-h-screen items-center `}>
        ...
        {tabs.map(({ title, bgClass, icon }, index) => (
          ...
          >
            <div
              ...
              className={`${bgClass} ${active === index ? 'top-0' : active < index ? '-top-full' : 'top-full'
            ...
            >
              <span
                ...
                className={`${activeTxt === index ? 'bg-[red]' : bgClass
              ...
              <span
                className={`hidden md:block transition-all duration-300 ${activeTxt === index ? 'text-[white]' : 'text-[blue]'
                  }`}
              >
                {title}
              </span>
