...
export default function Shablon() {
  ...
  return (
    <>
      <div className="shablon-container bg-transparent flex justify-between gap-5">
        <div className="filt-cont-shablonmanba w-[35%]  overflow-y-auto h-[50vh]">
            <div className="w-full text-white">
              ...
              {apiData?.period_filters?.length > 0 ? (
                <div className="transition-all duration-500 overflow-x-hidden w-full px-[40px]">
                  <button
        ...
        <div className="card-container-shablon w-[65%] lg:w-[90%] md:w-full">
          {loading ? ( // Display loader if loading
            ...
            apiData?.resources?.results.map((e, i) => (
              <div
                className="w-full flex items-center gap-1 h-[300px] md:h-[260px]"
                key={e?.id}
              >
                <div className="w-[33%] lg:w-2/5 pl-[10px] h-[95%]">
                  <img
                    className="bg-black h-[85%] w-full rounded"
                    onClick={() => navigate(`/cardDetail/${e?.id}`)}
                    src={`${e?.image}`}
                  />

                  <div className="w-[100%] flex justify-between px-5 md:justify-between md:px-0 text-white pt-[15px]">
                    <span className="flex gap-[3px] text-[15px] items-center">
                      <IoMdEye className="text-[18px] md:text-[16px]" /> 20534
                    </span>
                    <span className="flex gap-[3px] text-[15px] items-center">
                      <FaStar className="text-[16px] md:text-[16px]" /> 2900
                    </span>
                    <span className="flex gap-[3px] text-[15px] items-center">
                      <MdMessage className="text-[18px] md:text-[16px]" /> 2900
                    </span>
                  </div>
                </div>

                <div className="w-[67%] h-[95%] justify-between  p-[10px] flex items-center flex-col ">
                  <h2 className="line-clamp-3 text-white w-[100%]  text-[30px] md:text-[24px] sm:text-[20px] sm:leading-6 font-extrabold ">
                    {e?.title}
                  </h2>
                  <p className="md:text-lg text-white w-[100%] line-clamp-2 flex items-center gap-2 md:text-[16px]">
